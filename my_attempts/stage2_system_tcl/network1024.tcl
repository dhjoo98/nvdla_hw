...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.CLK_DOMAIN {bd_107b_pspmc_0_0_pl1_ref_clk} \
 ] [get_bd_intf_pins /NV_nvdla_wrapper_v1_0/m_axi]

  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {m_axi} \
   CONFIG.ASSOCIATED_PORT {} \
 ] [get_bd_pins /NV_nvdla_wrapper_v1_0/core_clk]

  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {s_apb} \
   CONFIG.ASSOCIATED_PORT {} \
 ] [get_bd_pins /NV_nvdla_wrapper_v1_0/csb_clk]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PS_PMC_CONFIG {\
     ...
     PMC_CRP_NOC_REF_CTRL_FREQMHZ {825}\
...
0} {CH2 0} {CH3 0} {CH4 0} {CH5 0} {CH6 0} {CH7 0} {CH8 1} {CH9 0}}\
  ...
  connect_bd_intf_net -intf_net NV_nvdla_wrapper_v1_0_m_axi [get_bd_intf_pins NV_nvdla_wrapper_v1_0/m_axi] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_apb_bridge_0_APB_M [get_bd_intf_pins NV_nvdla_wrapper_v1_0/s_apb] [get_bd_intf_pins axi_apb_bridge_0/APB_M]
  ...
  connect_bd_net -net NV_nvdla_wrapper_v1_0_dla_intr_0 [get_bd_pins NV_nvdla_wrapper_v1_0/dla_intr] [get_bd_pins versal_cips_0/pl_ps_irq8]
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins axi_apb_bridge_0/s_axi_aresetn] [get_bd_pins rst_versal_cips_0/interconnect_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn]
  connect_bd_net -net ext_reset_in_1 [get_bd_pins rst_versal_cips_0/ext_reset_in] [get_bd_pins versal_cips_0/pl0_resetn]
  connect_bd_net -net rst_versal_cips_0_peripheral_aresetn [get_bd_pins NV_nvdla_wrapper_v1_0/csb_rstn] [get_bd_pins NV_nvdla_wrapper_v1_0/rstn] [get_bd_pins rst_versal_cips_0/peripheral_aresetn]
  ...
  connect_bd_net -net versal_cips_0_pl1_ref_clk [get_bd_pins NV_nvdla_wrapper_v1_0/core_clk] [get_bd_pins NV_nvdla_wrapper_v1_0/csb_clk] [get_bd_pins axi_apb_bridge_0/s_axi_aclk] [get_bd_pins axi_noc_0/aclk0] [get_bd_pins axi_noc_0/aclk1] [get_bd_pins rst_versal_cips_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins versal_cips_0/pl1_ref_clk]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces NV_nvdla_wrapper_v1_0/m_axi] [get_bd_addr_segs axi_noc_0/S04_AXI/C0_DDR_LOW0] -force
  assign_bd_address -offset 0x020100000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/FPD_CCI_NOC_0] [get_bd_addr_segs NV_nvdla_wrapper_v1_0/s_apb/reg] -force
  ...
  assign_bd_address -offset 0x020100000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/FPD_CCI_NOC_1] [get_bd_addr_segs NV_nvdla_wrapper_v1_0/s_apb/reg] -force
  ...
  assign_bd_address -offset 0x020100000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/FPD_CCI_NOC_2] [get_bd_addr_segs NV_nvdla_wrapper_v1_0/s_apb/reg] -force
  ...
  assign_bd_address -offset 0x020100000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/FPD_CCI_NOC_3] [get_bd_addr_segs NV_nvdla_wrapper_v1_0/s_apb/reg] -force
