# based on versal restart TRD, modified for NVDLA
# the user must 1) create a project 2) set board as vmk180 and 3) then run the tcl on Vivado GUI
# also set the ip repository.




# 선배는 굳이 nvdla wrapper를 또 다시 nvdla subsystem으로 감쌌고
# Leiwang이나 Lund는 그냥 바로 nvdla wrapper를 global clk/reset에 연결함
# 또
# Leiwang은 PS에 DDR를 연결했지만 Lund는 PS에 DDR을 안 연결했어.

#일단 선배 티클을 Versal에 이식.
...
proc create_root_design { parentCell } {
  ...
  # Create instance, set properties, and connections
