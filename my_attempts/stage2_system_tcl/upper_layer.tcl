# a validated import of NVDLA_wrapper IP on server
################################################################
...
############################################im gonna need these anyway : DDR4 main mem, System Clk, and System rst
  ...
  # Create ports - not sure why this is needed
...
# Create instance: axi_noc_0, and set properties   --- ######  Use Processor rst/clk + NoC + CIPs chain from DMA
...
#########NoC(MC) to CIPS는 DMA를 최대한 따라서 + restart TRD와 교차검증
...
0} {CH2 0} {CH3 0} {CH4 0} {CH5 0} {CH6 0} {CH7 0} {CH8 1} {CH9 0}}\
 ...
 #[get_bd_intf_pins /NVDLA_system/NV_nvdla_wrapper_v1_0/m_axi_0] This part must have been uncompatible with 2022
  ...
  ##### Create NVDLA system port connections
  ##### Create interface connections -> Can skip subsystem AXI interconnect as NoC has reset. (which it actually doesn't)
  ...
  #connect_bd_intf_net -intf_net NV_nvdla_wrapper_v1_0_m_axi [get_bd_intf_pins NV_nvdla_wrapper_v1_0/m_axi_0] [get_bd_intf_pins axi_interconnect_4/S00_AXI]
  ...
  ### Create port connections;  for proc system reset
    # PS - NoC Interrupt  to Versal IRQ!
  connect_bd_net -net NV_nvdla_wrapper_v1_0_dla_intr_0 [get_bd_pins versal_cips_0/ps_pl_irq8] [get_bd_pins NV_nvdla_wrapper_v1_0/dla_intr_0]
    # PL resets
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins NV_nvdla_wrapper_v1_0/csb_rstn_0] [get_bd_pins NV_nvdla_wrapper_v1_0/rstn_0] [get_bd_pins axi_apb_bridge_0/s_axi_aresetn] [get_bd_pins rst_versal_cips_0/peripheral_aresetn]
    #external reset to PS
  connect_bd_net -net ext_reset_in_1 [get_bd_pins versal_cips_0\pl0_resetn] [get_bd_pins rst_versal_cips_0/ext_reset_in]

  ##########
  # interface connections (From DMA)
  #connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
    #NoC slave num 6
    #######NoC(MC)에서 NVDLA DMA port로 곧장 연결
  connect_bd_intf_net -intf_net nvdla_core2dbb [get_bd_intf_pins NV_nvdla_wrapper_v1_0/m_axi_0] [get_bd_intf_pins axi_noc_0/S06_AXI]
  ...
  connect_bd_intf_net -intf_net axi_noc_0_CH0_DDR4_0 [get_bd_intf_ports ddr4_dimm1] [get_bd_intf_pins axi_noc_0/CH0_DDR4_0]
    #NoC master to (DMA interface slave -> AXIAPBbridge AXI Lite)
    #######CIPS to NVDLA는 (=CSB) Master_slave만 맞게 구성
  connect_bd_intf_net -intf_net axi_noc_0_M00_AXI [get_bd_intf_pins axi_apb_bridge_0/AXI4_LITE] [get_bd_intf_pins axi_noc_0/M00_AXI]
    #SMA Clk as NoC sys clk
  ...
  connect_bd_intf_net -intf_net versal_cips_0_PMC_NOC_AXI_0 [get_bd_intf_pins axi_noc_0/S00_AXI] [get_bd_intf_pins versal_cips_0/PMC_NOC_AXI_0]
    #added AXI APB 2 NV_nvdla_wrapper (from Zynq SYSTEM)
  connect_bd_intf_net -intf_net axi_apb_bridge_0_APB_M [get_bd_intf_pins NV_nvdla_wrapper_v1_0/s_apb_0] [get_bd_intf_pins axi_apb_bridge_0/APB_M]

  # Create port connections (also from DMA) (CLks)
  ...
  connect_bd_net -net ext_reset_in_1 [get_bd_pins rst_versal_cips_0/ext_reset_in] [get_bd_pins versal_cips_0/pl0_resetn]
  # clk for entire system
  #connect_bd_net -net clk_wiz_0_clk_out1   [get_bd_pins rst_versal_cips_0/slowest_sync_clk]
  #connect_bd_net -net rst_versal_cips_0_333M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_0_smc/aresetn] [get_bd_pins rst_versal_cips_0/peripheral_aresetn]
  ...
  connect_bd_net -net versal_cips_0_lpd_axi_noc_clk [get_bd_pins axi_noc_0/aclk1] [get_bd_pins versal_cips_0/lpd_axi_noc_clk]
    #CIPS clk and NVDLA clk to processor reset
  #connect_bd_net -net versal_cips_0_pl0_ref_clk  [get_bd_pins clk_out1]  [get_bd_pins NV_nvdla_wrapper_v1_0/core_clk_0] [get_bd_pins NV_nvdla_wrapper_v1_0/csb_clk_0] [get_bd_pins axi_apb_bridge_0/s_axi_aclk] [get_bd_pins axi_noc_0/aclk6] [get_bd_pins rst_versal_cips_0/slowest_sync_clk] [get_bd_pins versal_cips_0/pl0_ref_clk]
  connect_bd_net -net versal_cips_0_pl0_ref_clk [get_bd_pins NV_nvdla_wrapper_v1_0/core_clk_0] [get_bd_pins NV_nvdla_wrapper_v1_0/csb_clk_0] [get_bd_pins axi_apb_bridge_0/s_axi_aclk] [get_bd_pins axi_noc_0/aclk6] [get_bd_pins rst_versal_cips_0/slowest_sync_clk] [get_bd_pins versal_cips_0/pl0_ref_clk]
