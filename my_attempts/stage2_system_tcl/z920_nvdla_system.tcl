...
#what he did was to
  #1) System RAM: allocate 4GB from offset 4_0000_0000 of ZYNQ Network Memory mapping
  #2) NVDLA shared memory: allocate the starting 1GB of that system RAM to NVDLA memory
