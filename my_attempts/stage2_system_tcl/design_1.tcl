...
proc create_root_design { parentCell } {
  ...
  set NV_nvdla_wrapper_0 [ create_bd_cell -type ip -vlnv user.org:user:NV_nvdla_wrapper:1.0 NV_nvdla_wrapper_0 ]

  # Create instance: versal_cips_0, and set properties
  set versal_cips_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:versal_cips:3.2 versal_cips_0 ]
  set_property -dict [ list \
   CONFIG.PS_PL_CONNECTIVITY_MODE {Single FPD & LPD Master/Slave} \
   CONFIG.PS_PMC_CONFIG {\
     PS_PL_CONNECTIVITY_MODE {Single FPD & LPD Master/Slave}\
     PS_USE_M_AXI_FPD {1}\
     PS_USE_M_AXI_LPD {1}\
     PS_USE_S_AXI_FPD {1}\
     PS_USE_S_AXI_LPD {1}\
