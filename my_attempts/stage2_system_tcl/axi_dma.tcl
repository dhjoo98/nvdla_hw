...
################################################################
# This is a generated script based on design: axi_dma
#
...
VCK190-AXIDMA-WTS-Example " [get_bd_designs $design_name]
...
proc create_root_design { parentCell } {
  ...
  set axi_dma_0_smc [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 axi_dma_0_smc ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
   CONFIG.NUM_SI {1} \
 ] $axi_dma_0_smc
...
1} {IO {PMC_MIO 26 .. 36}}}\
  ...
  assign_bd_address -offset 0x020100000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/FPD_CCI_NOC_0] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x020100000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/FPD_CCI_NOC_1] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x020100000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/FPD_CCI_NOC_2] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x020100000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/FPD_CCI_NOC_3] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x020100000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/LPD_AXI_NOC_0] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x020100000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/PMC_NOC_AXI_0] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] -force
