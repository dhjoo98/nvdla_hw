...
0} {CH2 0} {CH3 0} {CH4 0} {CH5 0} {CH6 0} {CH7 0} {CH8 1} {CH9 0}}\
  ...
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins NV_nvdla_wrapper_v1_0/csb_rstn_0] [get_bd_pins axi_apb_bridge_0/s_axi_aresetn] [get_bd_pins rst_versal_cips_0/interconnect_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn]
  connect_bd_net -net ext_reset_in_1 [get_bd_pins rst_versal_cips_0/ext_reset_in] [get_bd_pins versal_cips_0/pl0_resetn]
  connect_bd_net -net rst_versal_cips_0_peripheral_aresetn [get_bd_pins NV_nvdla_wrapper_v1_0/rstn_0] [get_bd_pins rst_versal_cips_0/peripheral_aresetn]
  ...
  connect_bd_net -net versal_cips_0_pl1_ref_clk [get_bd_pins NV_nvdla_wrapper_v1_0/core_clk_0] [get_bd_pins NV_nvdla_wrapper_v1_0/csb_clk_0] [get_bd_pins axi_apb_bridge_0/s_axi_aclk] [get_bd_pins axi_noc_0/aclk0] [get_bd_pins axi_noc_0/aclk1] [get_bd_pins axi_noc_0/sys_clk0] [get_bd_pins rst_versal_cips_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins versal_cips_0/pl1_ref_clk]
